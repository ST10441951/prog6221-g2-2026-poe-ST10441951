...
namespace CybersecurityChatbotGUI
{
    ...
    It manages the voice greeting (Task 1), the ASCII art (Task 1), and the personalised bridge phrases (Task 5).
    ...
    */
    public class BotInterface
    {
        ...
        */
        ...
        /* This method returns the ASCII art robot banner as a formatted string.
        It satisfies Task 1 by translating the Part 1 ASCII art into the GUI. 
        Returning it as a string instead of using Console.WriteLine allows the GUI to display it perfectly inside the RichTextBox.
        */
